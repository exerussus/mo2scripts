...
dct = {"domination": {
       ...
       "destroyerPickaxe": {
                        ...
                        "key10": {"name": "Количество ударов", "value": "1872"},  # время ходьбы вперёд
                        "key11": {"name": "1 доп. ячейка", "value": "t"},  # время ходьбы вперёд
                        "key12": {"name": "2 доп. ячейка", "value": "g"},  # время ходьбы вперёд
                        "key13": {"name": "3 доп. ячейка", "value": "b"},  # время ходьбы вперёд
                        "key14": {"name": "4 доп. ячейка", "value": "y"},  # время ходьбы вперёд
                        "key15": {"name": "5 доп. ячейка", "value": "h"},  # время ходьбы вперёд
                        "key16": {"name": "6 доп. ячейка", "value": "n"},  # время ходьбы вперёд
                        "key17": {"name": "7 доп. ячейка", "value": "u"},  # время ходьбы вперёд
                        "key18": {"name": "8 доп. ячейка", "value": "j"},  # время ходьбы вперёд
                        "key19": {"name": "9 доп. ячейка", "value": "m"},  # время ходьбы вперёд
                    },
       }
